...
const TeacherAssignmentDetails = () => {
    ...
    const { assignment, submissions, loading, error } = useSelector((state) => state.assignment);
    ...
    const handleOpenGradeDialog = (submission) => {
        ...
        setGradeData({
            marks: submission.marks !== undefined ? submission.marks : '',
    ...
    const handleSubmitGrade = async () => {
        if (selectedSubmission && gradeData.marks !== '') {
            ...
            await dispatch(gradeSubmission(selectedSubmission._id, {
                marks,
